  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'number',
        hint: 'Сколько Ralph ждёт весь набор команд проверок в одном контейнере. На пределе контейнер убивается, проверки считаются упавшими, попытка уходит в счётчик «Попыток пройти проверки». 3600000 — час.',
        unit: 'мс',
        default: 3600000,
      },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'list',
        hint: 'Манифесты и lock-файлы, которые Ralph копирует в слой зависимостей образа: package.json, package-lock.json, requirements.txt. Пути относительные, внутри проекта. Правка такого файла пересобирает образ, а незакоммиченная правка останавливает прогон.',
        unit: null,
        default: [],
      },
    ],
