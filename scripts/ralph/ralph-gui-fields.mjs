  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'number',
        hint: 'Ревью отклонило работу — issue возвращается в очередь с замечаниями в теле. После этого числа отказов подряд Ralph откладывает её. При включённой Lisa он сразу просит её о помощи; иначе берёт следующую issue. Отложенная issue не даёт закрыть milestone.',
        unit: null,
        default: 3,
      },
      {
        ...
        section: 'Lisa',
        label: 'Вызывать Lisa после остановки',
        type: 'boolean',
        hint: 'Lisa разбирает незавершённую работу и может вернуть её Ralph. Ручная остановка и stopAfterFirstIssue её не вызывают.',
        unit: null,
        default: false,
      },
      {
      ...
      },
      {
        ...
        allowCustom: true,
        hint: 'Список зависит от CLI Lisa. Новое имя модели можно ввести вручную.',
        unit: null,
        default: 'gpt-6-astra',
      },
      {
        ...
        optionsDependOn: 'supervisor.agentCli',
        hint: 'Глубина рассуждения отдельной сессии Lisa.',
        unit: null,
        default: 'low',
      },
      {
      ...
      },
      {
        ...
        type: 'number',
        hint: 'Ограниченный резерв Ralph после помощи Lisa. Каждое успешное вмешательство добавляет не больше одной итерации.',
        unit: null,
        default: 3,
      },
      {
