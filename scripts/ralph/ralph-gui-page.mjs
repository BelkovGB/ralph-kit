...
export const commandGuide = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Приёмка фазы живым сценарием",
        command: "/acceptance Фаза 2. Корзина",
        does:
          "На выходе — два файла в docs/acceptance: кейсы по критериям готовности закрытых " +
          "задач milestone и отчёт прогона с результатом по каждому кейсу и вердиктом " +
          "«принято» или «не принято». Кейсы собираются субагентами на дешёвой модели, " +
          "прогоны идут по одному в работающем приложении: состояние приложения общее, и " +
          "параллельные прогоны ломают проверки друг друга.",
        when: "Когда фаза закрыта, а pull request ещё черновик: перед тем как отдать работу людям.",
        omits:
          "Найденное не чинится, issues не заводятся. Приложение скилл не поднимает и не " +
          "гасит: адрес стенда и тестового пользователя берёт из инструкций проекта, а не " +
          "угадывает.",
      },
    ],
  },
