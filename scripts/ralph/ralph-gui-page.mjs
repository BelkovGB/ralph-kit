...
export const commandGuide = [
  ...
  },
  {
    ...
    note: "Перед работой Ralph-loop создайте в GitHub беклог: скиллы prd, solution-architect, plan-phase и issues по порядку.",
    items: [
      {
      ...
      {
        title: "Архитектура и обоснование технологий",
        ...
        when: "После PRD, перед планированием; повторно — при изменении значимых предпосылок.",
      ...
      },
      {
        ...
        does:
          ...
          "затронутые слои, критерии PRD и решения архитектуры. Фазу сдают целиком, " +
          "не дожидаясь остальных.",
        when: "После PRD и архитектуры, до создания задач. Недостающую архитектуру готовит перед планом.",
      ...
      },
      {
        ...
        does:
          ...
          "план и PRD, а в новом формате — также архитектура. Прежние планы работают без миграции.",
