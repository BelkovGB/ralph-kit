    ...
    items: [
      ...
      },
      {
        ...
        does:
          ...
          "PRD и архитектуру по одному SHA коммита: они переживут удаление файлов после сдачи фичи.",
        when: "Когда план, PRD и архитектура проверены, закоммичены и запушены.",
        omits:
